...
def caption_image_beam_search(encoder, decoder, image_path, 
                              word_map, gt_word, beam_size=1):
    """
...
"Compare raw scores"
def eval_trials(trial, img_scores, img_caption, gt, 
                set_name='untrained', model="model_1"):
...
if __name__ == '__main__':
    ...
    for n in range(1, args.num_models+1):
        ...
        for img in imgs:
            ...
            scores, seq, alphas = caption_image_beam_search(encoder, decoder, img_full, 
                                                            word_map, gt[img], args.beam_size)
